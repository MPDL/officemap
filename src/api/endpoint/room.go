...
func mapLeafletRoomToEndpointRoomMap(leafletRooms map[string]leaflet_map.Room) map[int]room {
...
func mapLeafletRoomToEndpointRoom(leafletRooms map[string]leaflet_map.Room) []room {
	endpointRooms := []room{}
	for _, leafletRoom := range leafletRooms {

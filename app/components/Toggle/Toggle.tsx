...
const Toggle = ({name, state, onChange, color, symbol} : Props) => {
	const colorVariant: {[index: string]: string} = {
		blue: "peer-checked:bg-officemap-blue-400",
		brown: "peer-checked:bg-officemap-brown-400",
		green: "peer-checked:bg-officemap-green-400", 
	}

	const symbolVariant: {[index: string]: string} = {
		person: "after:content-['person']",
		room: "after:content-['room']",
		printer: "after:content-['printer']",
	}
  ...
  return (
    <div className="flex flex-row mb-1.5">
      <label className="relative inline-flex items-center cursor-pointer">
        ...
        <div className={`w-11 h-6 bg-gray-200 rounded-full peer peer-checked:after:translate-x-full ${symbolVariant[symbol]} after:font-['icon'] after:content-center after:text-center after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:rounded-full after:h-5 after:w-5 after:transition-all ${colorVariant[color]}`}>
        </div>
